...
- **Eligibility floor:** eligibility is set by the round you keep *from*. Any player drafted **after Round 4** in 2026 (round 5 or later) can be kept in 2027. Advancing +4 may put their 2027 cost in R1–R4 (e.g. an R6 pick keeps at R2) — that is their **final** keeper year; they are permanently ineligible the season after. Only players already at R1–R4 in 2026 cannot be kept at all.
- **2026 One-Time Mulligan:** each team may keep one player who would otherwise fall in R1–R4 (i.e. would advance into the ineligibility band and be lost). That player is assigned to Round 1 for the 2026 draft. **The mulligan is a draft-day affordance only — it does NOT extend the player's keeper life.** From 2027 onward, every player kept at R1–R4 in 2026 (whether via mulligan, natural advancement, or otherwise) is permanently ineligible. Valid for the 2026 draft only; no future-year keeper math should treat mulligan-kept players differently from any other R1–R4 keeper. The dashboard's `keepable2027 = (2026_round > 4)` check already enforces this — a R1 mulligan keeper has a 2026 round of 1, which fails the test.
